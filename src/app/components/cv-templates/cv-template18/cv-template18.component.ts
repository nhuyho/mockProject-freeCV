...
@Component({
  selector: 'app-cv-template18',
  templateUrl: './cv-template18.component.html',
  styleUrls: ['./cv-template18.component.scss'],
  providers: [MessageService]
})
export class CvTemplate18Component implements OnInit, OnDestroy {
