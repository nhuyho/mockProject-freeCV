...
@Component({
  selector: 'app-cv-template20',
  templateUrl: './cv-template20.component.html',
  styleUrls: ['./cv-template20.component.scss'],
  providers: [MessageService]
})
export class CvTemplate20Component implements OnInit, OnDestroy {
