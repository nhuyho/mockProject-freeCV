...
@Component({
  selector: 'app-cv-template43',
  templateUrl: './cv-template43.component.html',
  styleUrls: ['./cv-template43.component.scss'],
  providers: [MessageService]
})

export class CvTemplate43Component implements OnInit, OnDestroy {
  ...
  colorCollection: Array<BackgroundOption> = [
    {
      color: '#db2d2e',
      backgroundUrl: 'https://firebasestorage.googleapis.com/v0/b/test-bb25d.appspot.com/o/images%2FbackgroundCV%2Fcv43%2Fbgred-43.png?alt=media&token=cd92359b-05db-4882-9b3a-628c77e1782b',
      secondTextColor: ''
    },
    {
      color: '#45cb6e',
      backgroundUrl: 'https://firebasestorage.googleapis.com/v0/b/test-bb25d.appspot.com/o/images%2FbackgroundCV%2Fcv43%2Fbg43%E2%80%9345CB6E.png?alt=media&token=934a6809-1582-4e92-acaa-52b7819f9da6',
      secondTextColor: ''
    }
  ];
