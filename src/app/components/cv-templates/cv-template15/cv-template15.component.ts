...
@Component({
  selector: 'app-cv-template15',
  templateUrl: './cv-template15.component.html',
  styleUrls: ['./cv-template15.component.scss'],
  providers: [MessageService]
})

export class CvTemplate15Component implements OnInit, OnDestroy {
