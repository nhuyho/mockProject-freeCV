...
@Component({
  selector: 'app-cv-template31',
  templateUrl: './cv-template31.component.html',
  styleUrls: ['./cv-template31.component.scss'],
  providers: [MessageService]
})
export class CvTemplate31Component implements OnInit, OnDestroy {
