...
@Component({
    selector: 'app-cv-template22',
    templateUrl: './cv-template22.component.html',
    styleUrls: ['./cv-template22.component.scss'],
    providers: [MessageService]
})
export class CvTemplate22Component implements OnInit {
